...
// ===== PASSWORD VISIBILITY TOGGLE — AUTO-INIT =====
...
// Run on DOMContentLoaded + after any dynamic modal injection
if (document.readyState === 'loading') {
  document.addEventListener('DOMContentLoaded', initPasswordToggles);
} else {
  initPasswordToggles();
}
// Re-run after modals open (auth popups injected dynamically)
